...
# sequência, o algoritmo deve exibir a mensagem “Ação bem sucedida!” e, caso não esteja, deve exibir a mensagem
# “A ação falhou...”.
...
valorN = int(input('Digite um valor numérico: '))
a = 1
b = 1
soma = 0

if valorN == 0 or valorN == 1:
